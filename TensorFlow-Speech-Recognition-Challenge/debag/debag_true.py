...
def call_fortran_poseidon(data,y_rc,_Wout,_in_node,_out_node,_rc_node,_traning_step,_rc_step):
        print(data)
        x_tr = data[:_traning_step,0]
        y_tr = data[:_traning_step,1]
...
call_fortran_poseidon(DATASET,data_out,Wout,ndim,out_node,rc_node+1,TRANING_STEP,RC_STEP)
